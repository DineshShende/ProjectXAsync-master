package com.projectx.async.fixtures.complete;
...
import com.projectx.async.domain.request.VehicleBrandDetails;
import com.projectx.async.domain.request.VehicleDetailsDTO;
import com.projectx.async.domain.request.VehicleTypeDetails;
